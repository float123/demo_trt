...
static PyMethodDef __pyx_mdef_4CTPN_3lib_5utils_7gpu_nms_1gpu_nms = {"gpu_nms", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4CTPN_3lib_5utils_7gpu_nms_1gpu_nms, METH_VARARGS|METH_KEYWORDS, 0};
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init CTPN.lib.utils.gpu_nms", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
